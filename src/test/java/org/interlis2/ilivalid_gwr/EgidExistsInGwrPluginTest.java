...
public class EgidExistsInGwrPluginTest {
    private static final String ILI_FUNCTION_NAME=EgidExistsInGwrPlugin.ILI_QUALIFIED_FUNCTION_NAME;
    private static final Class PLUGIN=EgidExistsInGwrPlugin.class;
