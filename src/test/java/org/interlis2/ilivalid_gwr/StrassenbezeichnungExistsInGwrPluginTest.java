...
public class StrassenbezeichnungExistsInGwrPluginTest {
    private static final String ILI_FUNCTION_NAME=StrassenbezeichnungExistsInGwrIoxPlugin.ILI_QUALIFIED_FUNCTION_NAME;
    private static final Class PLUGIN=StrassenbezeichnungExistsInGwrIoxPlugin.class;
    private static final String ILI_MODEL="StrassenbezeichnungExistsTest";
    private static final String ILI_TOPIC_A=ILI_MODEL+".TopicA";
    private static final String ILI_A_BODENBEDECKUNG_MUNICIPALITYID = "MunicipalityId";
    ...
    public void setUp() throws Exception {
        ...
        ili2cConfig.addFileEntry(new FileEntry("src/test/ili/StrassenbezeichnungExistsTest.ili", FileEntryKind.ILIMODELFILE));
    ...
    public void nameExists_Ok() {
        ...
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_MUNICIPALITYID,"5391");
    ...
    @Test
    public void nameDoesntExist_Fail() {
        Map<String,Class> userFunctions=new java.util.HashMap<String,Class>();
        userFunctions.put(ILI_FUNCTION_NAME,PLUGIN);
        Iom_jObject iomObj1=new Iom_jObject(ILI_A_BODENBEDECKUNG, "o1");
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_MUNICIPALITYID,"5391");
        ...
        Assert.assertEquals("Mandatory Constraint StrassenbezeichnungExistsTest.TopicA.Bodenbedeckung.GWRC02a is not true.",logger.getErrs().get(0).getEventMsg());
    }
    @Test
    public void multiNamesExists_Ok() {
        Map<String,Class> userFunctions=new java.util.HashMap<String,Class>();
        userFunctions.put(ILI_FUNCTION_NAME,PLUGIN);
        Iom_jObject iomObj1=new Iom_jObject(ILI_A_BODENBEDECKUNG, "o1");
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_MUNICIPALITYID,"5391");
        iomObj1.addattrvalue(ILI_A_BODENBEDECKUNG_STRNAME,"x");
        iomObj1.addattrvalue(ILI_A_BODENBEDECKUNG_STRNAME,"Corte Inferiore");
        ValidationConfig modelConfig=new ValidationConfig();
        LogCollector logger=new LogCollector();
        LogEventFactory errFactory=new LogEventFactory();
        Settings settings=new Settings();
