...
public class ExpectEgidEdidGwrPluginTest {
    private static final String ILI_FUNCTION_NAME=ExpectEgidEdidGwrIoxPlugin.ILI_QUALIFIED_FUNCTION_NAME;
    private static final Class PLUGIN=ExpectEgidEdidGwrIoxPlugin.class;
    private static final String ILI_MODEL="ExpectEgidEdidTest";
    ...
    private static final String ILI_A_BODENBEDECKUNG_GSTAT_EQUAL = "gstatEqual";
    ...
    public void setUp() throws Exception {
        ...
        ili2cConfig.addFileEntry(new FileEntry("src/test/ili/ExpectEgidEdidTest.ili", FileEntryKind.ILIMODELFILE));
    ...
    private Iom_jObject createValidObj() {
        ...
        iomObj1.addattrvalue(ILI_A_BODENBEDECKUNG_GSTAT_EQUAL,"0");
        iomObj1.addattrvalue(ILI_A_BODENBEDECKUNG_GSTAT_EQUAL,"1004");
        return iomObj1;
    }
    @Test
    public void exists_HausnummerUndefined_Ok() {
        ...
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_PLZ,"6809");
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_ORTSCHAFT,"Medeglia");
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_GSTAT_EQUAL,"1004");
        ValidationConfig modelConfig=new ValidationConfig();
        LogCollector logger=new LogCollector();
        LogEventFactory errFactory=new LogEventFactory();
        Settings settings=new Settings();
    ...
    public void wrongEgid_Fail() {
        ...
        Assert.assertEquals("Mandatory Constraint ExpectEgidEdidTest.TopicA.Bodenbedeckung.GWRC02a is not true.",logger.getErrs().get(0).getEventMsg());
    }
    @Test
    ...
    public void wrongGstat_Fail() {
        ...
        userFunctions.put(ILI_FUNCTION_NAME,PLUGIN);
        Iom_jObject iomObj1 = createValidObj();
        iomObj1.setattrvalue(ILI_A_BODENBEDECKUNG_GSTAT_EQUAL,"0");
        ValidationConfig modelConfig=new ValidationConfig();
        LogCollector logger=new LogCollector();
        LogEventFactory errFactory=new LogEventFactory();
        Settings settings=new Settings();
